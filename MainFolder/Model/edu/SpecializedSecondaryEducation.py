...
from MainFolder.config import DEFAULT_TECHNICHIAL_EDUCATIONAL_LEVEL, DEFAULT_MIDLE_EDUCATIONAL_LEVEL, \
...
class ProfessionalTechnicalEducation(EducationalInstitution):
    ...
    def add_speciality(self, speciality: Speciality, dto:DTO):
        speciality.education_level = DEFAULT_MIDLE_EDUCATIONAL_LEVEL
